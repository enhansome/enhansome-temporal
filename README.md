...
* [All lists](https://github.com/sindresorhus/awesome) ⭐ 508,093 | 🐛 106 | 📅 2026-09-02
* [Microservices](https://github.com/mfornos/awesome-microservices#readme) ⭐ 14,515 | 🐛 11 | 📅 2026-08-20
* [Distributed systems](https://github.com/madd86/awesome-system-design) ⭐ 12,497 | 🐛 21 | 📅 2026-02-27
* [Software architecture](https://github.com/simskij/awesome-software-architecture#readme) ⭐ 2,888 | 🐛 3 | 📅 2026-04-19
* [Queues](https://github.com/tonyhb/awesome-queues-jobs-and-tasks/) ⭐ 17 | 🐛 1 | 📅 2023-03-22
* Languages we have SDKs in:
  * [Python](https://github.com/vinta/awesome-python#readme) ⭐ 321,855 | 🐛 22 | 🌐 Python | 📅 2026-09-20
  * [Go](https://github.com/avelino/awesome-go#readme) ⭐ 184,862 | 🐛 230 | 🌐 Go | 📅 2026-09-20
  * [Node](https://github.com/sindresorhus/awesome-nodejs#readme) ⭐ 66,868 | 🐛 25 | 📅 2026-09-02
  * [Rust](https://github.com/rust-unofficial/awesome-rust#readme) ⭐ 59,448 | 🐛 12 | 🌐 Rust | 📅 2026-09-20
  * [Java](https://github.com/akullpp/awesome-java#readme) ⭐ 49,059 | 🐛 3 | 📅 2026-09-19
  * [JavaScript](https://github.com/sorrycc/awesome-javascript#readme) ⭐ 35,029 | 🐛 23 | 📅 2026-09-08
  * [PHP](https://github.com/ziadoz/awesome-php#readme) ⭐ 32,699 | 🐛 92 | 📅 2026-07-13
  * [.NET](https://github.com/quozd/awesome-dotnet#readme) ⭐ 21,618 | 🐛 162 | 📅 2026-03-26
  * [Ruby](https://github.com/markets/awesome-ruby#readme) ⭐ 14,156 | 🐛 9 | 📅 2026-09-08
* Databases we support:
  * [Postgres](https://github.com/dhamaniasad/awesome-postgres#readme) ⭐ 12,101 | 🐛 73 | 📅 2026-08-31
  * [MySQL](https://github.com/shlomi-noach/awesome-mysql#readme) ⭐ 2,614 | 🐛 19 | 🌐 Python | 📅 2026-09-14
...
* [`platacard/terraform-provider-temporal`](https://github.com/platacard/terraform-provider-temporal) ⭐ 37 | 🐛 7 | 🌐 Go | 📅 2026-09-17 - Terraform provider to manage Temporal Server resources.
...
* [iWF](https://github.com/indeedeng/iwf) ⭐ 661 | 🐛 79 | 🌐 Go | 📅 2026-08-28 - DSL workflow framework built on Temporal.
* [Output](https://github.com/growthxai/output) ⭐ 438 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-18 - AI Agents & Workflows with versioned prompts, evals, tracing, and credentials in one TypeScript framework built on Temporal.
* [Tenuo](https://github.com/tenuo-ai/tenuo) ⭐ 92 | 🐛 97 | 🌐 Rust | 📅 2026-09-20 - Per-call authorization for Temporal activities. Each Activity is checked against that call's arguments, and authority is traced across delegation chains.
* [awaithumans](https://github.com/awaithumans/awaithumans) ⭐ 23 | 🐛 17 | 🌐 Python | 📅 2026-09-11 - HITL primitive for AI agents. One function call (`await_human` / `awaitHuman`) suspends the workflow until a real person reviews via Slack, email, or a built-in dashboard, then resumes with the typed response. The Temporal adapter uses signals to park the workflow while it waits — durable across worker restarts. Python + TypeScript SDKs, Apache 2.0.
...
* [Go SDK](https://github.com/temporalio/sdk-go) ⭐ 970 | 🐛 229 | 🌐 Go | 📅 2026-09-18
* [Go SDK docs](https://t.mp/go)
* [Go SDK API reference](https://t.mp/go-api)

### Samples

* [`temporalio/samples-go`](https://github.com/temporalio/samples-go) ⭐ 749 | 🐛 64 | 🌐 Go | 📅 2026-09-18
...
* [agenticenv/agent-sdk-go](https://github.com/agenticenv/agent-sdk-go) ⭐ 56 | 🐛 3 | 🌐 Go | 📅 2026-09-20 - Temporal-first framework for building durable, production-grade AI agents in Go with native tools, MCP, human-in-the-loop approvals, and sub-agent delegation.
...
* [`cito-oss/tempo`](https://github.com/cito-oss/tempo) ⭐ 7 | 🐛 0 | 🌐 Go | 📅 2026-09-19 - Run distributed Go-like tests using Temporal.
...
* [TypeScript SDK](https://github.com/temporalio/sdk-typescript) ⭐ 919 | 🐛 198 | 🌐 TypeScript | 📅 2026-09-20
...
* [Java SDK](https://github.com/temporalio/sdk-java) ⭐ 433 | 🐛 281 | 🌐 Java | 📅 2026-09-20
* [Java SDK docs](https://t.mp/java)
* [Java SDK API reference](https://t.mp/java-api)

### Samples

* [`temporalio/samples-java`](https://github.com/temporalio/samples-java) ⭐ 258 | 🐛 47 | 🌐 Java | 📅 2026-09-18
...
* [Python SDK](https://github.com/temporalio/sdk-python) ⭐ 1,195 | 🐛 105 | 🌐 Python | 📅 2026-09-20
* [Python SDK docs](https://t.mp/py)
* [Python SDK API reference](https://t.mp/py-api)

### Samples

* [`temporalio/samples-python`](https://github.com/temporalio/samples-python) ⭐ 367 | 🐛 83 | 🌐 Python | 📅 2026-09-19
...
* [.NET SDK](https://github.com/temporalio/sdk-dotnet) ⭐ 569 | 🐛 65 | 🌐 C# | 📅 2026-09-18
* [.NET SDK docs](https://dotnet.temporal.io/)

### Samples

* [`temporalio/samples-dotnet`](https://github.com/temporalio/samples-dotnet) ⭐ 114 | 🐛 22 | 🌐 C# | 📅 2026-09-18
...
* [PHP SDK](https://github.com/temporalio/sdk-php) ⭐ 421 | 🐛 47 | 🌐 PHP | 📅 2026-09-17
...
* [RoadRunner](https://github.com/roadrunner-server/roadrunner) ⭐ 8,506 | 🐛 45 | 🌐 Go | 📅 2026-09-18 - PHP application server and process manager.
...
* [Ruby SDK](https://github.com/temporalio/sdk-ruby) ⭐ 204 | 🐛 31 | 🌐 Ruby | 📅 2026-09-18
...
* [Rust SDK](https://github.com/temporalio/sdk-rust) ⭐ 523 | 🐛 87 | 🌐 Rust | 📅 2026-09-18 - Currently in Public Preview.
...
* [Julep: Modern, Scalable, Resilient AI workflows](https://github.com/julep-ai/julep) ⭐ 6,584 | 🐛 2 | 🌐 Python | 📅 2026-08-06
* [Workflow Builder](https://github.com/synergycodes/workflowbuilder) ⭐ 372 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-20 - Embeddable, data-driven visual workflow editor SDK for React (Apache 2.0). The execution engine is swappable by design and proven with Temporal, giving you a working end-to-end reference for durable AI orchestration.
...
* [All those who have contributed](https://github.com/temporalio/awesome-temporal/graphs/contributors) ⭐ 464 | 🐛 0 | 📅 2026-09-14
